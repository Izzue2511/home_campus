...
class ScheduleVisitDetailsScreen extends StatefulWidget {
  @override
  _ScheduleVisitDetailsScreenState createState() => _ScheduleVisitDetailsScreenState();
...
class _ScheduleVisitDetailsScreenState extends State<ScheduleVisitDetailsScreen> {
...
onTapIcback15(BuildContext context) { Navigator.pushNamed(context, AppRoutes.scheduledRequestedScreen); } 
onTapRowgroupfortyei(BuildContext context) { Navigator.pushNamed(context, AppRoutes.rescheduleDateScreen); } 
onTapAcceptschedule(BuildContext context) { Navigator.pushNamed(context, AppRoutes.confirmedScheduledSuccessfullyScreen); }
