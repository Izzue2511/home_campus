...
class ScheduledRequestedScreen extends StatefulWidget {
  @override
  _ScheduledRequestedScreenState createState() => _ScheduledRequestedScreenState();
...
class _ScheduledRequestedScreenState extends State<ScheduledRequestedScreen> {
...
// Function to check if the user is authenticated
  ...
  void onTapRequested(BuildContext context, String bookingId) {
    ...
    Navigator.pushNamed(context, '/schedule_visit_details_screen', arguments: bookingId);
  }

  void onTapConfirmed(BuildContext context, String bookingId) {
    print('Selected Booking ID: $bookingId');
    Provider.of<UserProvider>(context, listen: false).setBookingId(bookingId);
    Navigator.pushNamed(context, '/schedule_visit_confirmed_owner_screen', arguments: bookingId);
  }

  void onTapCanceled(BuildContext context, String bookingId) {
    print('Selected Booking ID: $bookingId');
    Provider.of<UserProvider>(context, listen: false).setBookingId(bookingId);
    Navigator.pushNamed(context, '/schedule_visit_canceled_owner_screen', arguments: bookingId);
  }
  ...
  Stream<List<Booking_Property>> readRequested(String ownerId) =>
  ...
  Stream<List<Booking_Property>> readConfirmed(String ownerId) =>
      FirebaseFirestore.instance
          .collection('booking_property')
          .where('owner_id', isEqualTo: ownerId) // Add a filter based on the owner_id
  ...
  Stream<List<Booking_Property>> readCanceled(String ownerId) =>
      FirebaseFirestore.instance
          .collection('booking_property')
          .where('owner_id', isEqualTo: ownerId) // Add a filter based on the owner_id
...
onTapCancelCanceled(
      BuildContext context) { Navigator.pushNamed(context, AppRoutes.scheduledRequestedScreen); }
onTapHomeicon(BuildContext context) { Navigator.pushNamed(context, AppRoutes.homeHouseOwnerScreen); } 
onTapButton(BuildContext context) { Navigator.pushNamed(context, AppRoutes.addHouseRentalScreen); }
