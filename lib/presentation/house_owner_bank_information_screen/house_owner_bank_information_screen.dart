...
class HouseOwnerBankInformationScreen extends StatefulWidget {
  @override
  _HouseOwnerBankInformationScreenState createState() =>
      _HouseOwnerBankInformationScreenState();
}
...
class _HouseOwnerBankInformationScreenState
    extends State<HouseOwnerBankInformationScreen> {
  ...
  Widget buildOwner(House_Owner owner, String currentUserId) => Container(
            ...
            child: SingleChildScrollView(
                              ...
                              return AlertDialog(
                                ...
                                actions: <Widget>[
                                  ...
                                  ElevatedButton(
                                    child: Text('Delete'),
                                    onPressed: () {
                                      final docOwner = FirebaseFirestore
                                          .instance
                      ...
                      Container(
                        ...
                        child: IconButton(
                          icon: Icon(
                            ...
                            size:
                                25, // Adjust the size according to your preference
                          ),
                          onPressed: () {
              ...
              Container(
                margin: getMargin(
                    ...
                    top: 28,
                    right:
                        33), // <-- Moved margin after the positional arguments
                padding: getPadding(
                  left: 16,
                  top: 9,
                  right: 16,
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
        child: Scaffold(
            ...
            body: FutureBuilder<House_Owner?>(
  ...
  onTapConfirmDeleted(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.loginHouseOwnerScreen);
  }

  onTapCancelDeleted(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.profileHouseOwnerScreen);
  }

  onTapEditProfile(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.profileEditOwnerScreen);
  }

  onTapNotification(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.notificationOwnerScreen);
  }
  ...
  onTapButton(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.addHouseRentalScreen);
  }
