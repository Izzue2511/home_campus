...
class AdminRentalPropertyDetailsScreen extends StatefulWidget {
 @override
 _AdminRentalPropertyDetailsScreenState createState() => _AdminRentalPropertyDetailsScreenState();
...
class _AdminRentalPropertyDetailsScreenState extends State<AdminRentalPropertyDetailsScreen> {
...
/*
 ...
 onTapBtnIcback(BuildContext context) { Navigator.pushNamed(context, AppRoutes.homeAdminScreen); }
 onTapHome(
     BuildContext context) { Navigator.pushNamed(context, AppRoutes.homeAdminScreen); }
 onTapSchedule(
